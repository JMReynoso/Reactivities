...
//this class is used to seed our data after running the migration
public class DbInitializer
{
    public static async Task SeedData(AppDbContext context)
    {
        // check if the database is already seeded
        if (context.Activities.Any())   return; // database is already seeded, exit the method
        ...
        // tell ef that we updated an entity so it can keep track of it (in memory) and save changes
